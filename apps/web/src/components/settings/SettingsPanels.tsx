...
function CodeFontRow({
  title,
  description = "Code blocks in chat.",
  preview,
}: {
  title?: string;
  description?: string;
...
function WordWrapRow() {
  ...
  return (
    <SettingsRow
      ...
      description="Wrap long lines in code blocks and tables by default."
      resetAction={
 ...
 * interface font, so the demos under each row show every surface the choice
 * reaches.
 */
function SimpleFontRows() {
  return (
    <>
      ...
      <CodeFontRow title="Monospace font" preview={<CodeFontPreview />} />
    </>
  );
}
    ...
    <SettingsPageContainer>
      <SettingsSection title="General">
        ...
        <SettingsRow
          ...
          description="How often Usage reloads plan limits."
          resetAction={
            settings.usageRefreshMinutes !== DEFAULT_UNIFIED_SETTINGS.usageRefreshMinutes ? (
              <SettingResetButton
                label="usage refresh"
