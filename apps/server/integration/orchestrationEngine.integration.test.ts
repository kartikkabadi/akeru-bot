      ...
      Effect.gen(function* () {
        ...
        const turnResponse: TestTurnResponse = {
          events: [
            {
              type: "turn.started",
              ...runtimeBase("evt-single-1", "2026-02-24T10:00:00.000Z", CURSOR_PROVIDER),
              threadId: THREAD_ID,
              turnId: FIXTURE_TURN_ID,
            },
            {
              type: "message.delta",
              ...runtimeBase("evt-single-2", "2026-02-24T10:00:00.100Z", CURSOR_PROVIDER),
              threadId: THREAD_ID,
              turnId: FIXTURE_TURN_ID,
            ...
            {
              type: "turn.completed",
              ...runtimeBase("evt-single-3", "2026-02-24T10:00:00.200Z", CURSOR_PROVIDER),
              threadId: THREAD_ID,
              turnId: FIXTURE_TURN_ID,
              status: "completed",
            },
        ...
        assert.equal(
          thread.messages.find((message) => message.role === "assistant")?.text,
