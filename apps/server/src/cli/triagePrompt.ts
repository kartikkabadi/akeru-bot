...
- If \`gh\` is not authenticated, offer \`gh auth login\`, or build a prefilled
  https://github.com/opencoredev/akeru-bot/issues/new URL with title and body query
...
having a problem with their install and started this session with \`akeru triage\`.
...
Generated by \`akeru triage\` at ${input.generatedAt}.
