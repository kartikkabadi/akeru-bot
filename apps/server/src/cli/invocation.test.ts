...
it("detects package runners from their cache entry paths", () => {
  assert.equal(
    detectCliRunner("/home/theo/.npm/_npx/abc123/node_modules/akeru-bot/dist/bin.mjs"),
    "npx",
  );
  assert.equal(
    detectCliRunner(
  ...
  assert.equal(
    detectCliRunner("/home/theo/.cache/pnpm/dlx/abc/node_modules/akeru-bot/dist/bin.mjs"),
    "pnpm dlx",
  );
  assert.equal(
    detectCliRunner(
      "/home/theo/.local/share/pnpm/.pnpm/dlx/abc/node_modules/akeru-bot/dist/bin.mjs",
    ),
    "pnpm dlx",
  );
  assert.equal(
  ...
  assert.equal(
    detectCliRunner("/home/theo/.bun/install/cache/akeru-bot@0.0.31/dist/bin.mjs"),
    "bunx",
  );
  assert.equal(
  ...
  assert.equal(
    detectCliRunner(
      "C:\\Users\\theo\\AppData\\Local\\Temp\\bunx-0-akeru-bot@latest\\node_modules\\akeru-bot\\dist\\bin.mjs",
    ),
    "bunx",
  );
});
...
it("treats stable installs as direct invocations", () => {
  ...
  assert.isNull(detectCliRunner("/home/theo/Code/work/akeru-bot/apps/server/dist/bin.mjs"));
  assert.isNull(
    detectCliRunner("/home/theo/.akeru/runtime/0.0.31/node_modules/akeru-bot/dist/bin.mjs"),
  );
...
it("formats serve suggestions to match the launching command", () => {
  assert.equal(
    formatCliCommand({
      subcommand: "serve",
      entryPath: "/home/theo/.npm/_npx/abc/node_modules/akeru-bot/dist/bin.mjs",
