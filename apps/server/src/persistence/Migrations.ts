...
import Migration0052 from "./Migrations/052_HostedMcpAuthentication.ts";
import Migration0053 from "./Migrations/053_HostedMcpAuthenticationColumn.ts";
...
export const migrationEntries = [
  ...
  [52, "HostedMcpAuthentication", Migration0052],
  [53, "HostedMcpAuthenticationColumn", Migration0053],
] as const;
