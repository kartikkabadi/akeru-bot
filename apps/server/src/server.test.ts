...
import * as ProjectionMcpServers from "./persistence/Services/ProjectionMcpServers.ts";
    ...
    const servedRoutesLayer = HttpRouter.serve(
      ...
      Layer.provide(
        Layer.mergeAll(
          ...
          Layer.succeed(ProjectionMcpServers.ProjectionMcpServerRepository, {
            upsert: () => Effect.void,
            getById: () => Effect.succeed(Option.none()),
            listAll: () => Effect.succeed([]),
            deleteById: () => Effect.void,
          } satisfies ProjectionMcpServers.ProjectionMcpServerRepositoryShape),
