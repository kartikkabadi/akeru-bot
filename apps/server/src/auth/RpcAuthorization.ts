...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.subscriptionAuthLocalClis]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.mcpAuthList]: AuthOrchestrationReadScope,
  [WS_METHODS.mcpAuthStart]: AuthOrchestrationOperateScope,
  [WS_METHODS.mcpAuthPoll]: AuthOrchestrationOperateScope,
  [WS_METHODS.mcpAuthComplete]: AuthOrchestrationOperateScope,
  [WS_METHODS.mcpAuthCancel]: AuthOrchestrationOperateScope,
  [WS_METHODS.mcpAuthDisconnect]: AuthOrchestrationOperateScope,
